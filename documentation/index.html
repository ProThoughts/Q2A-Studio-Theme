...
<body>
	...
	<div class="section sTop">
		...
		<div class="inner">
			<h1>Studio Theme - Free Q2A Theme </h1>
			<p>Created & Documented by &ldquo;<a href="http://towhidn.com/" style="color: rgb(34, 34, 136);" title="freelance Q2A Developer and designer">Towhid</a>&rdquo;  -  v1.2.0  - Provided by <a href="http://QA-Themes.com/" style="color: rgb(34, 34, 136);" title="Question2Answer distributor">Q2A Themes</a></p>
			<small>v2.0.0</small>
		</div>
		<br class="clear">
	</div>
	...
	<div class="section s1">
		...
		<div class="inner">
			...
			<ol>
				<li><p>Extract <strong>studio-theme.zip</strong>.</p></li>
				<li>upload Content of <strong>studio-theme</strong> directory to <strong>qa-themes/</strong> directory in your Q2A site</li>
				<li><p>Log in as Administrator, then Go to <strong>Admin &gt; General</strong> and select 'Studio-Theme' as your default theme.</p></li>
				<li>Go to <strong>Admin &gt; <i>Theme Options</i></strong>. there you can customize your theme.</li>
			</ol>
			</br><p>if you had any problems installing or using this theme feel free to ask for help on <a title="Q2A support forum" href="http://qa-themes.com/forums/">Our Forum</a>.</p>
			<p>if you are paid customer you can contact me directly at <a href="http://qa-themes.com/contact-us">QA-Themes.com</a></p>
			<p>check out this theme's <a href="http://demo.qa-themes.com/studio/">demo</a>.</p>
		</div>
	</div>

	<div class="section s2">
		<div class="inner">
			<p><strong>Studio Theme</strong> offers a wide range of customizations that you can easily apply on your theme.</p>
			...
			<ol>
				...
				<li><strong>Background Customization:</strong> This options let you choose 'background color' & 'background image'. you can even add more backgrounds!</li>
				<li><strong>Typography:</strong> you can change the Font & Font Size of nearly everything in this theme.</li>
				<li><strong>CSS Style compression:</strong> you can choose any of CSS compressions</li>
				<li><strong>CSS Style customization:</strong> you can add your CSS files to customized the theme.</li>
			</ol>			
		</div>
	...
	<div class="section s3">
		...
		<p>you have more backgrounds that you want to try on your theme? simply save them as .png files and upload the file in 'qa-themes/studio-theme/patterns' and it will be added to backgrounds list.</p>
		...
		<p>to add a new CSS file you can upload it in 'qa-themes/studio-theme/styles' or you can edit one of pre-made styles.</p>
		</div>
	...
	<div class="section s4">
		<div class="inner">
			...
			<p>For free support you can post your requests on <a title="Question2Answer support forum" href="http://qa-themes.com/forums/">Our Forum</a>.
			<p>if you have suggestion or requests for free themes and plugins you can send them on our <a href="http://idea.qa-themes.com/" title="Q2A Ideas and Suggestions">Idea Box</a> or vote other suggestions and ideas</p>
